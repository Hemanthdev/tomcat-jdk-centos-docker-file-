...
RUN  tar -zxf jdk-8u121-linux-x64.tar.gz -C /usr/local/oracle-java-8
RUN  update-alternatives --install "/usr/bin/java" "java" "/usr/local/oracle-java-8/jdk1.8.0_121/bin/java" 1500
RUN  update-alternatives --install "/usr/bin/javac" "javac" "/usr/local/oracle-java-8/jdk1.8.0_121/bin/javac" 1500
RUN  update-alternatives --install "/usr/bin/javaws" "javaws" "/usr/local/oracle-java-8/jdk1.8.0_121/bin/javaws" 1500
